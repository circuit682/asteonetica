...
export const ASTROPHOTOGRAPHY_OBJECTS: AstrophotographyObject[] = [
  ...
  },
  {
    ...
    label: 'Southern Pinwheel Galaxy',
    versions: [
      {
        id: 'southern-pinwheel-galaxy-primary',
        objectId: 'southern-pinwheel-galaxy',
        versionKey: 'primary',
        versionLabel: 'Primary Capture',
        title: 'Southern Pinwheel Galaxy',
        subtitle: 'M83 - Barred Spiral Galaxy',
        description:
          'A barred spiral galaxy in Hydra with compact spiral structure and a bright nuclear region, often called the Southern Pinwheel.',
        imagePath: '/astrophotography/southern-pinwheel-galaxy/southern-pinwheel-galaxy.jpeg',
        imageFormat: 'jpeg',
        variants: {
          mobile: '/astrophotography/southern-pinwheel-galaxy/southern-pinwheel-galaxy-600w.webp',
          tablet: '/astrophotography/southern-pinwheel-galaxy/southern-pinwheel-galaxy-1024w.webp',
          desktop: '/astrophotography/southern-pinwheel-galaxy/southern-pinwheel-galaxy-1920w.webp',
        },
        highRes: '/astrophotography/southern-pinwheel-galaxy/southern-pinwheel-galaxy-4k.webp',
        width: 1600,
        height: 1600,
        metadata: {
          cod: 'M83 / NGC 5236',
          obs: 'ReqGroup 2474982 | Sub-request 4144973 | Target M83 | Submitted 2026-03-25 16:25:11 | Updated 2026-03-25 16:58:29',
          mea: 'Duration 1016s | Instrument 0m4 SCICAM QHY600 | Acceptability threshold 90% | Proposal LCOEPO2023B-007',
          tel: 'Submitter Lisa | IPP 1.050000 | Type NORMAL | Window 2026-03-25 16:21:15 to 2026-03-26 23:59:00',
          ack: 'Source: LCO request 4144973 screenshot (2026-04-11).',
        },
        cinematicGlow: true,
        glowColor: '#BB1E10',
      },
  ...
  },
  {
    ...
    versions: [
      {
        id: 'sombrero-galaxy-primary',
        objectId: 'sombrero-galaxy',
        versionKey: 'primary',
        versionLabel: 'Primary Capture',
        title: 'Sombrero Galaxy',
        subtitle: 'M104 - NGC 4594',
        description:
          'An edge-on spiral galaxy with a bright central bulge and a prominent dark dust lane across the disk.',
        imagePath: '/astrophotography/sombrero-galaxy/sombrero-galaxy.jpeg',
        imageFormat: 'jpeg',
        variants: {
          mobile: '/astrophotography/sombrero-galaxy/sombrero-galaxy-600w.webp',
          tablet: '/astrophotography/sombrero-galaxy/sombrero-galaxy-1024w.webp',
          desktop: '/astrophotography/sombrero-galaxy/sombrero-galaxy-1920w.webp',
        },
        highRes: '/astrophotography/sombrero-galaxy/sombrero-galaxy-4k.webp',
        width: 1600,
        height: 1600,
        metadata: {
          cod: 'M104 / NGC 4594',
          obs: 'Local upload | Sombrero Galaxy primary frame.',
          mea: '1600px source converted to 600w, 1024w, 1920w, and 4k WebP variants.',
          tel: 'Capture details were not included in the uploaded package.',
          ack: 'Source: local upload (2026-04-12).',
        },
        cinematicGlow: true,
        glowColor: '#00FF9C',
      },
  ...
  {
    id: 'sombrero-galaxy-ii',
    label: 'Sombrero Galaxy II',
    versions: [
      {
        id: 'sombrero-galaxy-ii-primary',
        objectId: 'sombrero-galaxy-ii',
        versionKey: 'primary',
        versionLabel: 'Primary Capture',
        title: 'Sombrero Galaxy II',
        subtitle: 'M104 - Alternate Frame',
        description:
          'A second Sombrero Galaxy rendering kept as a separate gallery version for comparison and sequencing.',
        imagePath: '/astrophotography/sombrero-galaxy-ii/sombrero-galaxy-ii.jpeg',
        imageFormat: 'jpeg',
        variants: {
          mobile: '/astrophotography/sombrero-galaxy-ii/sombrero-galaxy-ii-600w.webp',
          tablet: '/astrophotography/sombrero-galaxy-ii/sombrero-galaxy-ii-1024w.webp',
          desktop: '/astrophotography/sombrero-galaxy-ii/sombrero-galaxy-ii-1920w.webp',
        },
        highRes: '/astrophotography/sombrero-galaxy-ii/sombrero-galaxy-ii-4k.webp',
        width: 1600,
        height: 1600,
        metadata: {
          cod: 'M104 / NGC 4594',
          obs: 'Local upload | Sombrero Galaxy alternate frame.',
          mea: '1600px source converted to 600w, 1024w, 1920w, and 4k WebP variants.',
          tel: 'Capture details were not included in the uploaded package.',
          ack: 'Source: local upload (2026-04-12).',
        },
  ...
  {
    id: 'skull-and-cross-bone-nebula',
    label: 'Skull and Cross Bone Nebula',
    versions: [
      {
        id: 'skull-and-cross-bone-nebula-primary',
        objectId: 'skull-and-cross-bone-nebula',
        versionKey: 'primary',
        versionLabel: 'Primary Capture',
        title: 'Skull and Cross Bone Nebula',
        subtitle: 'NGC 2467 - Emission Nebula',
        description:
          'A compact emission nebula commonly known for its skull-like structure and clustered star-forming regions.',
        imagePath: '/astrophotography/skull-and-cross-bone-nebula/skull-and-cross-bone-nebula.jpeg',
        imageFormat: 'jpeg',
        variants: {
          mobile: '/astrophotography/skull-and-cross-bone-nebula/skull-and-cross-bone-nebula-600w.webp',
          tablet: '/astrophotography/skull-and-cross-bone-nebula/skull-and-cross-bone-nebula-1024w.webp',
          desktop: '/astrophotography/skull-and-cross-bone-nebula/skull-and-cross-bone-nebula-1920w.webp',
        },
        highRes: '/astrophotography/skull-and-cross-bone-nebula/skull-and-cross-bone-nebula-4k.webp',
        width: 1600,
        height: 1600,
        metadata: {
          cod: 'NGC 2467',
          obs: 'Local upload | Skull and Cross Bone Nebula primary frame.',
          mea: '1600px source converted to 600w, 1024w, 1920w, and 4k WebP variants.',
          tel: 'Capture details were not included in the uploaded package.',
          ack: 'Source: local upload (2026-04-12).',
        },
